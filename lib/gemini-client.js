...
2. Use moveSignals for patterns and criticalMoments for position-specific claims. Reference only supplied ply numbers.
3. A critical-moment classification and preferredMove must be copied exactly from that criticalMoment.
4. Evidence-based claims use basis "engine". Broader study advice uses basis "general_coaching_advice" and must cite the supporting plies that motivated it.
